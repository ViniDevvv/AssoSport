...
class CompetitionSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('COMPETITION')->upsert([
            ...
            ['COM_ID' => 'com4', 'CLU_ID' => 'clu4', 'DIS_ID' => 'Ath', 'CLU_ID_LOCAL' => 'clu5', 'COM_NOM' => 'Athle 100m 2026', 'COM_DATE' => '2026-06-20'],
        ...
        ], ['COM_ID'], ['CLU_ID', 'DIS_ID', 'CLU_ID_LOCAL', 'COM_NOM', 'COM_DATE']);
    }
}
